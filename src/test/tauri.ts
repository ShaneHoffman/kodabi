 ...
 * (so `emit` right after render reaches the subscriber), but the returned
...
/** Delivers a backend event to every live subscriber. Wrap calls in React's
 * `act` — subscribers set state synchronously. */
