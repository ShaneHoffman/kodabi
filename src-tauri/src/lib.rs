...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ledger_cmds::untrack_commitment,
            ledger_cmds::untrack_commitments,
            ledger_cmds::snooze_commitments,
            ledger_cmds::mark_commitments_seen,
            ledger_cmds::claim_commitment_mine,
