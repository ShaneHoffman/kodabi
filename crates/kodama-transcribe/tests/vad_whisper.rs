...
//!
//! ```text
//! WHISPER_MODEL=... VAD_MODEL=... cargo test -p kodama-transcribe --features whisper -- --ignored
//! ```
//!
...
use kodama_core::transcription::{transcribe_all, AudioChunk, TranscriptionEngine};
use kodama_transcribe::{whisper_with_vad, VadConfig, WhisperConfig};
