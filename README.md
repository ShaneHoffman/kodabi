...
crates/kodabi-mcp/      # Stdio MCP server (hand-rolled JSON-RPC) exposing the v1 tool surface
                        # (read: search_notes, get_note, list_projects; write:
                        # file_note_to_project, add_glossary_term) over kodabi-core.
