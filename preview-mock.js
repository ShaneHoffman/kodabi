...
(function () {
  ...
  const projectNotes = [
    { id: "n_p1", path: "briarwood-golf/budget.md", title: "Budget review with owners", type: "meeting", project: "briarwood-golf", date: "2026-07-19", tags: ["budget"], source: "meeting", confidence: null, snippet: "Owners walked the Q3 budget; the clubhouse line is the swing item this quarter." },
    { id: "n_p2", path: "briarwood-golf/renovation.md", title: "Course renovation standup", type: "meeting", project: "briarwood-golf", date: "2026-07-18", tags: ["renovation"], source: "meeting", confidence: null, snippet: "Fairway regrading starts on the back nine." },
    { id: "n_p3", path: "briarwood-golf/clubhouse.md", title: "Clubhouse opening punch list", type: "note", project: "briarwood-golf", date: "2026-07-17", tags: ["clubhouse"], source: "manual", confidence: null, snippet: "Signage, furniture delivery, and the final inspection." },
    { id: "n_p4", path: "briarwood-golf/financing.md", title: "Owner call: financing options", type: "meeting", project: "briarwood-golf", date: "2026-07-16", tags: ["finance"], source: "meeting", confidence: null, snippet: "A refinance would free budget for the range netting and cart-barn roof." },
    { id: "n_p5", path: "briarwood-golf/grounds.md", title: "Groundskeeping schedule notes", type: "note", project: "briarwood-golf", date: "2026-07-15", tags: [], source: "manual", confidence: null, snippet: "Mowing cadence through August." },
  ];
  ...
  const responses = {
    list_projects: () => ({
      ...
      projects: [
        project("briarwood-golf", "Briarwood Golf", null, 14),
        project("briarwood-golf/pro-shop", "Pro Shop", "briarwood-golf", 4),
